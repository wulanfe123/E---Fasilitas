...
// Cek login
if (!isset($_SESSION['id_user']) || !in_array($_SESSION['role'], ['bagian_umum', 'super_admin'])) {
    ...
    <main>
        <div class="container-fluid">
            ...
            <div class="row g-4 mb-4">
                <!-- Fasilitas Card (sekarang kartu pertama) -->
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="stat-card stat-card-blue">
                        <div class="stat-card-body">
                            ...
                            <div class="stat-card-content">
                                <div class="stat-card-number"><?= number_format($statPengembalian); ?></div>
                                <div class="stat-card-label">Total Pengembalian</div>
                            </div>
                        </div>
                        <a href="pengembalian.php" class="stat-card-footer">
                            <span>Kelola</span>
                            <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                        ...
                        <div class="quick-stats-body">
                            ...
                            <div class="quick-stat-item">
                                ...
                                <div class="quick-stat-content">
                                    ...
                                    <div class="quick-stat-label">Laporan Pengembalian</div>
                                </div>
                            </div>
                            ...
                            <div class="quick-stat-item">
                                ...
                                <div class="quick-stat-content">
                                    <div class="quick-stat-value">
                                        <?php 
                                        $persentase = $statPeminjaman > 0 
                                            ? round(($statPengembalian / $statPeminjaman) * 100) 
                                            : 0;
                                        echo $persentase . '%';
                                        ?>
                                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (ctxPeminjaman) {
        new Chart(ctxPeminjaman, {
            type: 'line',
            data: {
                labels: bulanLabelsPeminjaman.length > 0 
                    ? bulanLabelsPeminjaman 
                    : ['Jan','Feb','Mar','Apr','Mei','Jun','Jul','Ags','Sep','Okt','Nov','Des'],
                datasets: [{
                    label: 'Jumlah Peminjaman',
                    data: dataPeminjaman.length > 0 
                        ? dataPeminjaman 
                        : Array(12).fill(0),
    ...
    if (ctxKondisi) {
        new Chart(ctxKondisi, {
            type: 'bar',
            data: {
                labels: bulanLabelsKondisi.length > 0
                    ? bulanLabelsKondisi
                    : ['Jan','Feb','Mar','Apr','Mei','Jun','Jul','Ags','Sep','Okt','Nov','Des'],
                datasets: [
                    {
                        label: 'Baik',
                        data: dataKondisiBaik.length > 0 
                            ? dataKondisiBaik 
                            : Array(12).fill(0),
                    ...
                    {
                        label: 'Rusak',
                        data: dataKondisiRusak.length > 0 
                            ? dataKondisiRusak 
                            : Array(12).fill(0),
