...
/* =========================================================
   5. HANDLE CREATE / UPDATE (HANYA bagian_umum, PREPARED)
   ========================================================== */
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="datatablesSimple" class="table table-bordered table-hover align-middle mb-0">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="<?= $role === 'bagian_umum' ? 8 : 7; ?>" class="text-center text-muted py-4">
...
$(document).ready(function() {
    $('#datatablesSimple').DataTable({
        ...
        order: [[0, 'asc']],
        columnDefs: [
            { orderable: false, targets: [4, <?= $role === 'bagian_umum' ? 7 : 6; ?>] }
        ]
    });
});
