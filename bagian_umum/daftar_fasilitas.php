...
if (!in_array($role, ['bagian_umum', 'super_admin'])) {
...
/* =========================================================
   5. HANDLE CREATE / UPDATE (HANYA bagian_umum)
   ========================================================= */
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $role === 'bagian_umum') {
    $action          = $_POST['action'] ?? '';
...
/* =========================================================
   6. HANDLE DELETE (HANYA bagian_umum) + CEK FOREIGN KEY
   ========================================================= */
if (isset($_GET['delete']) && $role === 'bagian_umum') {
    ...
    <div class="card shadow-sm border-0 mb-4 card-fasilitas">
        ...
        <div class="card-body">
            <table id="datatablesSimple" class="table table-bordered table-hover align-middle mb-0">
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="<?= $role === 'bagian_umum' ? 8 : 7; ?>" class="text-center text-muted py-3">
